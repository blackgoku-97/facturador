<invoice>
    <div class="well well-sm">
        <div class="row">
            ...
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="correlative" readonly value="{correlative}" />
            </div>
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="reference" readonly value="{reference}" />
            </div>
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="fecha" readonly value="{fecha}" />
            </div>
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="costo" readonly value="{costo}" />
            </div>
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="area" readonly value="{area}" />
            </div>
            <div class="col-md-3">
                <input class="form-control" type="text" placeholder="monto" readonly value="{monto}" />
            </div>
        </div>
    </div>
            ...
            var client = $("#client"),
                ...
                list: {
                    onClickEvent: function() {
                        ...
                        self.client_id = e.id;
                        self.rut = e.rut;
                        self.correlative = e.correlative;
