<html>
    ...
    <div class="header">
        <h1>
            Caja Chica # {{ str_pad ($model->id, 7, '0', STR_PAD_LEFT) }}
            <small>
    ...
    <table class="client-detail">
        ...
        <tr>
            <th>Rut</th>
            <td>{{ $model->client->rut }}</td>
        </tr>
        <tr>
            <th>N° Correlativo</th>
            <td>{{ $model->client->correlative }}</td>
        </tr>
        <tr>
            <th>Referencia</th>
            <td>{{ $model->client->reference }}</td>
        </tr>
        <tr>
            <th>Fecha</th>
            <td>{{ $model->client->fecha }}</td>
        </tr>
        <tr>
            <th>C.Costos</th>
            <td>{{ $model->client->costo }}</td>
        </tr>
        <tr>
            <th>C.Area</th>
            <td>{{ $model->client->area }}</td>
        </tr>
        <tr>
            <th>Monto</th>
            <td>{{ $model->client->monto }}</td>
        </tr>
    </table>
